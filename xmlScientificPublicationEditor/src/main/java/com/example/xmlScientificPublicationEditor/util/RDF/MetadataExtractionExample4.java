...
public class MetadataExtractionExample4 {
	...
	public static void main(String[] args) throws Exception {
		run(AuthenticationUtilities.loadPropertiesFusekiJena());
	}
	
	public static void run(ConnectionPropertiesFusekiJena conn) throws IOException, SAXException, TransformerException {
		
		System.out.println("[INFO] " + MetadataExtractionExample4.class.getSimpleName());
		
		// Referencing XML file with RDF data in attributes
		String xmlFilePath = "src/main/resources/data/rdfa/contacts.xml";
		
		String rdfFilePath = "src/main/resources/data/rdfa/output.rdf";
